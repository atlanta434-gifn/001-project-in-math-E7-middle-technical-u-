...
# إخفاء عناصر التحكم الافتراضية لرفع الخصوصية
st.markdown("""
    <style>
...
st.markdown("""
    <div style="background-color:#1e1e1e; padding:15px; border-radius:10px; border-bottom: 4px solid #2e7d32; text-align:center;">
        ...
        <p style="color:#bbb; margin:0;">إعداد طلاب شعبة E7: علي منتظر | عبدالله فراس | ايمن مصطفى | علي نهاد قادر | حسن محمد جاسم | حسين صباح نوري</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    try:
        ...
        if user_msg:
            ...
            with st.spinner("Analyzing..."):
                prompt = f"أنت مهندس خبير ومساعد ذكي صممتك 'شعبة E7' من قسم هندسة الالكترونيك والذكاء الاصطناعي في MTU. أجب باختصار وبالعربية على: {user_msg}"
